...
I love cyberpunk[^rtcp] and I need an OSR system for it. CY_Borg somewhat fills that role but it is very intentionally light on details, especially for the GM. Things that can really add to an ongoing campaign like resource management and dungeon crawl procedures are abscent. Borg games very much assume that the GM has solutions for these problems that they like. I prefer systems that have put some thought into said problems.

An Into the Odd style cyberpunk game would be my ideal TRPG. The core system is just so easy to GM and write for that it feels like any genre will fit with the right additions. So I want to start putting that game out there, piece by piece, publicly. Starting in the most genre defining part, hacking.
...
- Hacker should always be in danger
- Some like lockpicking, time investment
- Some like a puzzle
- Some like a second layer of the dungeon

[^rtcp]: The genre as a whole, not just the R Talsorian TRPG.
[^cpt-crunch]: WIKI PAGE
